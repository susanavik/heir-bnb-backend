...
Listing.create(name: "Napa Winery", location: "Napa, CA", image: "https://static3.mansionglobal.com/production/media/article-images/0a2c7fce68fd99aa0961e1faea29ed32/large_1187.jpg", description: "It's stunning, on the beach!", price: 3500)
Listing.create(name: "Austin's Finest Mansion", location: "Austin, TX", image: "https://photos.zillowstatic.com/fp/df5687be1224767c4b87d221ff470508-uncropped_scaled_within_1536_1152.webp", description: "Lovely cabin, sleeps 25, makes you feel one with nature", price: 1500)
Listing.create(name: "White Italian Monstrocity", location: "Amalfi Coast, Italy", image: "https://images.lvhglobal.com/property/large/6193_5d30b46e46667.jpg", description: "Jump on in to the stunning pools, or take a climb into the coastal rock formations", price: 2000)
Listing.create(name: "The English Countryside Mansion", location: "Manchester, England", image: "https://i.pinimg.com/originals/1c/10/05/1c1005e6e76c6d7013a749fb3c613856.jpg", description: "A proper get away in the English countryside. Horse stables on property and avialable to ride into the sunset", price: 2500)
Listing.create(name: "Perry's Palace", location: "Atlanta, GA", image: "https://images.mansionglobal.com/im-191825?width=1280", description: "Hidden in plain view, this Atlanta jewel gives all the luxury and comfort you can dream of", price: 10000)

Listing.create(name: "Skier Paradise", location: "Vail, CO", image: "https://images.mansionglobal.com/im-301213/?size=0&width=1280", description: "Ski-in luxury in the heart of Breaver Creek!", price: 1270)
...
Listing.create(name: "Telluride's Winter Wonderland", location: "Telluride, CO", image: "https://robbreport.com/wp-content/uploads/2016/04/01a1.jpg?w=991", description: "This Telluride Benchmark House is an alpine ski-in/ski-out private luxury home located in the heart of the Tellluride ski resort", price: 780)
Listing.create(name: "Jackson's Finest", location: "Jackson Hole, WY", image: "https://img.gtsstatic.net/reno/imagereader.aspx?imageurl=https%3A%2F%2Fsir.azureedge.net%2F1103i215%2Ft38952vpacxc4c2yaashn97ge2i215&option=N&permitphotoenlargement=false&w=1200", description: "The best that Jackson Hole has to offer located just north of downtown Jackson", price: 7000)
Listing.create(name: "The Alps Chalet", location: "Courchevel, France", image: "https://www.sothebysrealty-france.com/theme/_default/images/spacer.png", description: "Chalet ideally placed for the centre of Courchevel 1850 ski resort", price: 2500)
Listing.create(name: "A Traditional Swiss Chalet", location: "St. Moritz, Switzerland", image: "https://ucarecdn.com/df5399e5-357d-4cbd-b528-b993a83c78ed/", description: "This dreamlike property embodies irresistible charm, security and style", price: 3500)
